...
public class SoMoXConfigurationAttributeMapTest {
     ...
     * @return A matcher that will match if all return values of all getters of the
     *         reference configuration and the examined configuration are equal or
     *         behave equally.
     */
    private static Matcher<SoMoXConfiguration> behavesLike(final SoMoXConfiguration configuration) {
        return new TypeSafeDiagnosingMatcher<SoMoXConfiguration>() {
            /**
             * Getters that return values that need to be examined on their own. Note that
             * this list applies for any examination level.
             */
            private final Set<String> gettersToExamine = new HashSet<>(
                    Arrays.asList("getFileLocations", "getClusteringConfig", "getBlacklistFilter"));
            ...
            protected boolean matches(final Object reference, final Object examined,
                ...
                // find all getters using reflection. This ensures that future modifications
                // will be
                // included
