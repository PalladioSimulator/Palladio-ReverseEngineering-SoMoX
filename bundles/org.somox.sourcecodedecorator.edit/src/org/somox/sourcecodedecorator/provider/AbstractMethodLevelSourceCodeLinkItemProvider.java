    ...
    protected void addFunctionPropertyDescriptor(final Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AbstractMethodLevelSourceCodeLink_function_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_AbstractMethodLevelSourceCodeLink_function_feature",
                                "_UI_AbstractMethodLevelSourceCodeLink_type"),
                        SourcecodedecoratorPackage.Literals.ABSTRACT_METHOD_LEVEL_SOURCE_CODE_LINK__FUNCTION, true,
