 ...
 * {@link org.somox.sourcecodedecorator.ControlFlowLevelSourceCodeLink} object.
...
public class ControlFlowLevelSourceCodeLinkItemProvider extends MethodLevelSourceCodeLinkItemProvider {
    ...
    protected void addAbstractActionPropertyDescriptor(final Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ControlFlowLevelSourceCodeLink_abstractAction_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ControlFlowLevelSourceCodeLink_abstractAction_feature",
                                "_UI_ControlFlowLevelSourceCodeLink_type"),
                        SourcecodedecoratorPackage.Literals.CONTROL_FLOW_LEVEL_SOURCE_CODE_LINK__ABSTRACT_ACTION, true,
    ...
    /**
     * This returns ControlFlowLevelSourceCodeLink.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
