...
public class ComponentImplementingClassesLinkItemProvider extends ItemProviderAdapter
    ...
    protected void addComponentPropertyDescriptor(final Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ComponentImplementingClassesLink_component_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ComponentImplementingClassesLink_component_feature",
                                "_UI_ComponentImplementingClassesLink_type"),
                        SourcecodedecoratorPackage.Literals.COMPONENT_IMPLEMENTING_CLASSES_LINK__COMPONENT, true, false,
                        true, null, null, null));
    }
    ...
    protected void addSubComponentsPropertyDescriptor(final Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ComponentImplementingClassesLink_subComponents_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_ComponentImplementingClassesLink_subComponents_feature",
                                "_UI_ComponentImplementingClassesLink_type"),
                        SourcecodedecoratorPackage.Literals.COMPONENT_IMPLEMENTING_CLASSES_LINK__SUB_COMPONENTS, true,
                        false, true, null, null, null));
    }
    ...
    /**
     * This returns ComponentImplementingClassesLink.gif. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public String getText(final Object object) {
        ...
        return getString("_UI_ComponentImplementingClassesLink_type") + " "
