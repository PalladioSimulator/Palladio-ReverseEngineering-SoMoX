 ...
 * {@link org.somox.sourcecodedecorator.InterfaceSourceCodeLink} object. <!--
...
public class InterfaceSourceCodeLinkItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addInterfacePropertyDescriptor(final Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_InterfaceSourceCodeLink_interface_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_InterfaceSourceCodeLink_interface_feature",
                                "_UI_InterfaceSourceCodeLink_type"),
                        SourcecodedecoratorPackage.Literals.INTERFACE_SOURCE_CODE_LINK__INTERFACE, true, false, true,
                        null, null, null));
    }
    ...
    protected void addGastClassPropertyDescriptor(final Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_InterfaceSourceCodeLink_gastClass_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_InterfaceSourceCodeLink_gastClass_feature",
                                "_UI_InterfaceSourceCodeLink_type"),
                        SourcecodedecoratorPackage.Literals.INTERFACE_SOURCE_CODE_LINK__GAST_CLASS, true, false, true,
                        null, null, null));
    }

    /**
     * This returns InterfaceSourceCodeLink.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
