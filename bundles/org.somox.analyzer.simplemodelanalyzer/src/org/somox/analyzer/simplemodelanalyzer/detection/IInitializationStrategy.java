...
public interface IInitializationStrategy {
     ...
     * GAST class itself and the set of all inner, i.e., nested, classes
     *
     * @return A list of initial component candidates. This method guarantees that
     *         all components are {@link IPrimitiveComponentCandidate}s.
     */
    List<ComponentImplementingClassesLink> createInitialComponentCandidates(Root root, SoMoXConfiguration config,
