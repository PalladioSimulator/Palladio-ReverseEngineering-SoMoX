 ...
 * <ul>
 * <li>{@link metricvalues.ComponentCandidate#getMetricValues <em>Metric
 * Values</em>}</li>
 * <li>{@link metricvalues.ComponentCandidate#getFirstComponent <em>First
 * Component</em>}</li>
 * <li>{@link metricvalues.ComponentCandidate#getSecondComponent <em>Second
 * Component</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ComponentCandidate extends EObject {
    /**
     * Returns the value of the '<em><b>Metric Values</b></em>' containment
     * reference list. The list contents are of type
     * {@link metricvalues.MetricValue}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Metric Values</em>' containment reference list
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>First Component</em>' reference isn't clear, there
