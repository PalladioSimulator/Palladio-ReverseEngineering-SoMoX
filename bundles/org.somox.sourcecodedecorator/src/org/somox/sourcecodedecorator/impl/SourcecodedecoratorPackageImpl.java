...
public class SourcecodedecoratorPackageImpl extends EPackageImpl implements SourcecodedecoratorPackage {
     ...
     * {@link SourcecodedecoratorPackage#eINSTANCE} when that field is accessed.
    ...
    public void createPackageContents() {
        ...
        createEReference(sourceCodeDecoratorRepositoryEClass,
        ...
        createEReference(sourceCodeDecoratorRepositoryEClass,
                SOURCE_CODE_DECORATOR_REPOSITORY__SEFF_ELEMENTS_SOURCE_CODE_LINKS);
        ...
        createEAttribute(componentImplementingClassesLinkEClass,
        ...
        createEReference(componentImplementingClassesLinkEClass,
        ...
        createEReference(pcmSystemImplementatingClassesLinkEClass,
        ...
        methodLevelResourceDemandingInternalBehaviorLinkEClass = createEClass(
                METHOD_LEVEL_RESOURCE_DEMANDING_INTERNAL_BEHAVIOR_LINK);
        createEReference(methodLevelResourceDemandingInternalBehaviorLinkEClass,
    ...
    public void initializePackageContents() {
        ...
        methodLevelSourceCodeLinkEClass.getESuperTypes().add(getAbstractMethodLevelSourceCodeLink());
        controlFlowLevelSourceCodeLinkEClass.getESuperTypes().add(getMethodLevelSourceCodeLink());
        pcmSystemImplementatingClassesLinkEClass.getESuperTypes().add(getComponentImplementingClassesLink());
        dataTypeSourceCodeLinkEClass.getESuperTypes().add(getFileLevelSourceCodeLink());
        methodLevelResourceDemandingInternalBehaviorLinkEClass.getESuperTypes()
                .add(getAbstractMethodLevelSourceCodeLink());
        abstractMethodLevelSourceCodeLinkEClass.getESuperTypes().add(getFileLevelSourceCodeLink());

        // Initialize classes, features, and operations; add parameters
        initEClass(fileLevelSourceCodeLinkEClass, FileLevelSourceCodeLink.class, "FileLevelSourceCodeLink",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getFileLevelSourceCodeLink_RepositoryComponent(), theRepositoryPackage.getRepositoryComponent(),
                null, "repositoryComponent", null, 0, 1, FileLevelSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getFileLevelSourceCodeLink_File(), theContainersPackage.getCompilationUnit(), null, "file", null,
                0, 1, FileLevelSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(methodLevelSourceCodeLinkEClass, MethodLevelSourceCodeLink.class, "MethodLevelSourceCodeLink",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getMethodLevelSourceCodeLink_Operation(), theRepositoryPackage.getSignature(), null, "operation",
                null, 0, 1, MethodLevelSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(controlFlowLevelSourceCodeLinkEClass, ControlFlowLevelSourceCodeLink.class,
                "ControlFlowLevelSourceCodeLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getControlFlowLevelSourceCodeLink_AbstractAction(), theSeffPackage.getAbstractAction(), null,
                "abstractAction", null, 0, 1, ControlFlowLevelSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getControlFlowLevelSourceCodeLink_Statement(), theStatementsPackage.getStatement(), null,
                "statement", null, 0, 1, ControlFlowLevelSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(sourceCodeDecoratorRepositoryEClass, SourceCodeDecoratorRepository.class,
                "SourceCodeDecoratorRepository", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSourceCodeDecoratorRepository_FileLevelSourceCodeLink(), getFileLevelSourceCodeLink(), null,
                "fileLevelSourceCodeLink", null, 0, -1, SourceCodeDecoratorRepository.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_MethodLevelSourceCodeLink(), getMethodLevelSourceCodeLink(),
                null, "methodLevelSourceCodeLink", null, 0, -1, SourceCodeDecoratorRepository.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_ControlFlowLevelSourceCodeLink(),
                getControlFlowLevelSourceCodeLink(), null, "controlFlowLevelSourceCodeLink", null, 0, -1,
                SourceCodeDecoratorRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_InterfaceSourceCodeLink(), getInterfaceSourceCodeLink(), null,
                "interfaceSourceCodeLink", null, 0, -1, SourceCodeDecoratorRepository.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_ComponentImplementingClassesLink(),
                getComponentImplementingClassesLink(), null, "componentImplementingClassesLink", null, 0, -1,
                SourceCodeDecoratorRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_DataTypeSourceCodeLink(), getDataTypeSourceCodeLink(), null,
                "dataTypeSourceCodeLink", null, 0, -1, SourceCodeDecoratorRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_AbstractActionClassMethodLink(),
                getAbstractActionClassMethodLink(), null, "abstractActionClassMethodLink", null, 0, -1,
                SourceCodeDecoratorRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_MethodLevelResourceDemandingInternalBehaviorLink(),
                getMethodLevelResourceDemandingInternalBehaviorLink(), null,
                "methodLevelResourceDemandingInternalBehaviorLink", null, 0, -1, SourceCodeDecoratorRepository.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_Seff2MethodMappings(), getSEFF2MethodMapping(), null,
                "seff2MethodMappings", null, 0, -1, SourceCodeDecoratorRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSourceCodeDecoratorRepository_SeffElementsSourceCodeLinks(), getSeffElementSourceCodeLink(),
                null, "seffElementsSourceCodeLinks", null, 0, -1, SourceCodeDecoratorRepository.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);

        initEClass(interfaceSourceCodeLinkEClass, InterfaceSourceCodeLink.class, "InterfaceSourceCodeLink",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getInterfaceSourceCodeLink_Interface(), theRepositoryPackage.getInterface(), null, "interface",
                null, 0, 1, InterfaceSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getInterfaceSourceCodeLink_GastClass(), theClassifiersPackage.getConcreteClassifier(), null,
                "gastClass", null, 0, 1, InterfaceSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(componentImplementingClassesLinkEClass, ComponentImplementingClassesLink.class,
                "ComponentImplementingClassesLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getComponentImplementingClassesLink_IsCompositeComponent(), ecorePackage.getEBoolean(),
                "isCompositeComponent", null, 1, 1, ComponentImplementingClassesLink.class, IS_TRANSIENT, IS_VOLATILE,
                !IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
        initEReference(getComponentImplementingClassesLink_Component(), theRepositoryPackage.getRepositoryComponent(),
        ...
        initEReference(getComponentImplementingClassesLink_ImplementingClasses(),
                ...
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getComponentImplementingClassesLink_SubComponents(), getComponentImplementingClassesLink(), null,
                "subComponents", null, 0, -1, ComponentImplementingClassesLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getComponentImplementingClassesLink_ProvidedInterfaces(), getInterfaceSourceCodeLink(), null,
                "providedInterfaces", null, 0, -1, ComponentImplementingClassesLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getComponentImplementingClassesLink_RequiredInterfaces(), getInterfaceSourceCodeLink(), null,
                "requiredInterfaces", null, 0, -1, ComponentImplementingClassesLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getComponentImplementingClassesLink_IsInitialComponent(), ecorePackage.getEBoolean(),
                "isInitialComponent", null, 1, 1, ComponentImplementingClassesLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(pcmSystemImplementatingClassesLinkEClass, PCMSystemImplementatingClassesLink.class,
                "PCMSystemImplementatingClassesLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getPCMSystemImplementatingClassesLink_SystemModel(), theSystemPackage.getSystem(), null,
                "systemModel", null, 0, 1, PCMSystemImplementatingClassesLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(dataTypeSourceCodeLinkEClass, DataTypeSourceCodeLink.class, "DataTypeSourceCodeLink", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getDataTypeSourceCodeLink_JaMoPPType(), theTypesPackage.getType(), null, "jaMoPPType", null, 0,
                1, DataTypeSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDataTypeSourceCodeLink_PcmDataType(), theRepositoryPackage.getDataType(), null, "pcmDataType",
                null, 0, 1, DataTypeSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDataTypeSourceCodeLink_InnerDatatypeSourceCodeLink(), getInnerDatatypeSourceCodeLink(), null,
                "innerDatatypeSourceCodeLink", null, 0, -1, DataTypeSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(innerDatatypeSourceCodeLinkEClass, InnerDatatypeSourceCodeLink.class, "InnerDatatypeSourceCodeLink",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getInnerDatatypeSourceCodeLink_Field(), theMembersPackage.getField(), null, "field", null, 0, 1,
                InnerDatatypeSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInnerDatatypeSourceCodeLink_InnerDeclaration(), theRepositoryPackage.getInnerDeclaration(),
                null, "innerDeclaration", null, 0, 1, InnerDatatypeSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(abstractActionClassMethodLinkEClass, AbstractActionClassMethodLink.class,
                "AbstractActionClassMethodLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAbstractActionClassMethodLink_ClassMethod(), theMembersPackage.getClassMethod(), null,
                "classMethod", null, 0, 1, AbstractActionClassMethodLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getAbstractActionClassMethodLink_AbstractAction(), theSeffPackage.getAbstractAction(), null,
                "abstractAction", null, 0, 1, AbstractActionClassMethodLink.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(methodLevelResourceDemandingInternalBehaviorLinkEClass,
        ...
        initEReference(getMethodLevelResourceDemandingInternalBehaviorLink_ResourceDemandingInternalBehaviour(),
        ...
        initEClass(abstractMethodLevelSourceCodeLinkEClass, AbstractMethodLevelSourceCodeLink.class,
                "AbstractMethodLevelSourceCodeLink", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAbstractMethodLevelSourceCodeLink_Function(), theMembersPackage.getMember(), null, "function",
                null, 0, 1, AbstractMethodLevelSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(seff2MethodMappingEClass, SEFF2MethodMapping.class, "SEFF2MethodMapping", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSEFF2MethodMapping_Seff(), theSeffPackage.getServiceEffectSpecification(), null, "seff", null,
                1, 1, SEFF2MethodMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSEFF2MethodMapping_StatementListContainer(), theStatementsPackage.getStatementListContainer(),
                null, "statementListContainer", null, 1, 1, SEFF2MethodMapping.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(seffElementSourceCodeLinkEClass, SeffElementSourceCodeLink.class, "SeffElementSourceCodeLink",
                !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSeffElementSourceCodeLink_SeffElement(), theIdentifierPackage.getIdentifier(), null,
                "seffElement", null, 1, 1, SeffElementSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSeffElementSourceCodeLink_Statement(), theStatementsPackage.getStatement(), null, "statement",
                null, 1, -1, SeffElementSourceCodeLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
