 ...
 * </p>
 * <ul>
 * <li>{@link org.somox.sourcecodedecorator.impl.ComponentImplementingClassesLinkImpl#isIsCompositeComponent
 ...
 * <em>Component</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.impl.ComponentImplementingClassesLinkImpl#getImplementingClasses
 * <em>Implementing Classes</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.impl.ComponentImplementingClassesLinkImpl#getSubComponents
 * <em>Sub Components</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.impl.ComponentImplementingClassesLinkImpl#getProvidedInterfaces
 * <em>Provided Interfaces</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.impl.ComponentImplementingClassesLinkImpl#getRequiredInterfaces
 * <em>Required Interfaces</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.impl.ComponentImplementingClassesLinkImpl#isIsInitialComponent
...
public class ComponentImplementingClassesLinkImpl extends MinimalEObjectImpl.Container
    ...
    /**
     * The default value of the '{@link #isIsCompositeComponent() <em>Is Composite
     * Component</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getImplementingClasses() <em>Implementing
     * Classes</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getProvidedInterfaces() <em>Provided
     * Interfaces</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * The cached value of the '{@link #getRequiredInterfaces() <em>Required
     * Interfaces</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * The default value of the '{@link #isIsInitialComponent() <em>Is Initial
     * Component</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #isIsInitialComponent() <em>Is Initial
     * Component</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #isIsInitialComponent()
     * @generated
    ...
    public boolean isSetIsCompositeComponent() {
        // TODO: implement this method to return whether the 'Is Composite Component'
        // attribute is set
    ...
    public RepositoryComponent getComponent() {
        if ((component != null) && ((EObject) component).eIsProxy()) {
            final InternalEObject oldComponent = (InternalEObject) component;
            component = (RepositoryComponent) eResolveProxy(oldComponent);
            if ((component != oldComponent) && eNotificationRequired()) {
    ...
    public void setComponent(final RepositoryComponent newComponent) {
        final RepositoryComponent oldComponent = component;
    ...
    public EList<ConcreteClassifier> getImplementingClasses() {
        if (implementingClasses == null) {
            implementingClasses = new EObjectResolvingEList<>(ConcreteClassifier.class, this,
    ...
    public EList<ComponentImplementingClassesLink> getSubComponents() {
        if (subComponents == null) {
            subComponents = new EObjectResolvingEList<>(ComponentImplementingClassesLink.class, this,
    ...
    public EList<InterfaceSourceCodeLink> getProvidedInterfaces() {
        if (providedInterfaces == null) {
            providedInterfaces = new EObjectResolvingEList<>(InterfaceSourceCodeLink.class, this,
    ...
    public EList<InterfaceSourceCodeLink> getRequiredInterfaces() {
        if (requiredInterfaces == null) {
            requiredInterfaces = new EObjectResolvingEList<>(InterfaceSourceCodeLink.class, this,
    ...
    public void setIsInitialComponent(final boolean newIsInitialComponent) {
        final boolean oldIsInitialComponent = isInitialComponent;
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ...
                    oldIsInitialComponent, isInitialComponent));
        }
    }
