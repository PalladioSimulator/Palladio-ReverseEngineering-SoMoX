 ...
 * <li>{@link org.somox.sourcecodedecorator.impl.FileLevelSourceCodeLinkImpl#getFile
 * <em>File</em>}</li>
 * </ul>
 *
 * @generated
...
public class FileLevelSourceCodeLinkImpl extends MinimalEObjectImpl.Container implements FileLevelSourceCodeLink {
    /**
     * The cached value of the '{@link #getRepositoryComponent() <em>Repository
    ...
    public RepositoryComponent getRepositoryComponent() {
        if ((repositoryComponent != null) && ((EObject) repositoryComponent).eIsProxy()) {
            final InternalEObject oldRepositoryComponent = (InternalEObject) repositoryComponent;
            repositoryComponent = (RepositoryComponent) eResolveProxy(oldRepositoryComponent);
            if ((repositoryComponent != oldRepositoryComponent) && eNotificationRequired()) {
    ...
    public void setRepositoryComponent(final RepositoryComponent newRepositoryComponent) {
        final RepositoryComponent oldRepositoryComponent = repositoryComponent;
    ...
    public CompilationUnit getFile() {
        if ((file != null) && file.eIsProxy()) {
            final InternalEObject oldFile = (InternalEObject) file;
            file = (CompilationUnit) eResolveProxy(oldFile);
            if ((file != oldFile) && eNotificationRequired()) {
                eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                        SourcecodedecoratorPackage.FILE_LEVEL_SOURCE_CODE_LINK__FILE, oldFile, file));
            }
        }
        return file;
    }
    ...
    public void setFile(final CompilationUnit newFile) {
        final CompilationUnit oldFile = file;
        file = newFile;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SourcecodedecoratorPackage.FILE_LEVEL_SOURCE_CODE_LINK__FILE, oldFile, file));
