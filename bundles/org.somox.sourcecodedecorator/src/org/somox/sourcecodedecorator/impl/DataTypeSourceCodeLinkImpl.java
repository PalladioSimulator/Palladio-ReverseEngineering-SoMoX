 ...
 * Type Source Code Link</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.somox.sourcecodedecorator.impl.DataTypeSourceCodeLinkImpl#getInnerDatatypeSourceCodeLink
...
public class DataTypeSourceCodeLinkImpl extends FileLevelSourceCodeLinkImpl implements DataTypeSourceCodeLink {
    /**
     * The cached value of the '{@link #getJaMoPPType() <em>Ja Mo PP Type</em>}'
    ...
    /**
     * The cached value of the '{@link #getPcmDataType() <em>Pcm Data Type</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #getPcmDataType()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getInnerDatatypeSourceCodeLink() <em>Inner
     * Datatype Source Code Link</em>}' containment reference list. <!--
    ...
    public Type getJaMoPPType() {
        if ((jaMoPPType != null) && jaMoPPType.eIsProxy()) {
            final InternalEObject oldJaMoPPType = (InternalEObject) jaMoPPType;
            jaMoPPType = (Type) eResolveProxy(oldJaMoPPType);
            if ((jaMoPPType != oldJaMoPPType) && eNotificationRequired()) {
    ...
    public void setJaMoPPType(final Type newJaMoPPType) {
        final Type oldJaMoPPType = jaMoPPType;
        jaMoPPType = newJaMoPPType;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SourcecodedecoratorPackage.DATA_TYPE_SOURCE_CODE_LINK__JA_MO_PP_TYPE, oldJaMoPPType, jaMoPPType));
        }
    }
    ...
    public DataType getPcmDataType() {
        if ((pcmDataType != null) && ((EObject) pcmDataType).eIsProxy()) {
            final InternalEObject oldPcmDataType = (InternalEObject) pcmDataType;
            pcmDataType = (DataType) eResolveProxy(oldPcmDataType);
            if ((pcmDataType != oldPcmDataType) && eNotificationRequired()) {
                eNotify(new ENotificationImpl(this, Notification.RESOLVE,
    ...
    public void setPcmDataType(final DataType newPcmDataType) {
        final DataType oldPcmDataType = pcmDataType;
        pcmDataType = newPcmDataType;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SourcecodedecoratorPackage.DATA_TYPE_SOURCE_CODE_LINK__PCM_DATA_TYPE, oldPcmDataType, pcmDataType));
        }
    }
    ...
    public EList<InnerDatatypeSourceCodeLink> getInnerDatatypeSourceCodeLink() {
        if (innerDatatypeSourceCodeLink == null) {
            innerDatatypeSourceCodeLink = new EObjectContainmentEList<>(InnerDatatypeSourceCodeLink.class, this,
