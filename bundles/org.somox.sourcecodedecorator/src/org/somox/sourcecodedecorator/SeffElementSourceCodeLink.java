 ...
 * </p>
 * <ul>
 * <li>{@link org.somox.sourcecodedecorator.SeffElementSourceCodeLink#getSeffElement
 * <em>Seff Element</em>}</li>
 * <li>{@link org.somox.sourcecodedecorator.SeffElementSourceCodeLink#getStatement
 * <em>Statement</em>}</li>
 * </ul>
 *
...
public interface SeffElementSourceCodeLink extends EObject {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Seff Element</em>' reference isn't clear, there
     ...
     * <em>Seff Element</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
