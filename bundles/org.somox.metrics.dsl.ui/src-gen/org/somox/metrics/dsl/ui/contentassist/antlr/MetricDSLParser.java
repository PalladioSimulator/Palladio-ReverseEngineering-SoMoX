        ...
        if (nameMappings == null) {
            nameMappings = new HashMap<>() {
...

                {
                    ...
                    put(grammarAccess.getMetricDefinitionAccess().getAlternatives(),
                    ...
                    put(grammarAccess.getMetricModelAccess().getImportURIAssignment_0_1(),
                            "rule__MetricModel__ImportURIAssignment_0_1");
                    put(grammarAccess.getMetricModelAccess().getMetricsAssignment_1_1(),
                            "rule__MetricModel__MetricsAssignment_1_1");
                    put(grammarAccess.getMetricModelAccess().getMetricsAssignment_4(),
                            "rule__MetricModel__MetricsAssignment_4");
                    put(grammarAccess.getExternalMetricAccess().getNameAssignment(),
                            "rule__ExternalMetric__NameAssignment");
                    put(grammarAccess.getInternalMetricAccess().getNameAssignment_1(),
                            "rule__InternalMetric__NameAssignment_1");
                    put(grammarAccess.getInternalMetricAccess().getShortNameAssignment_3(),
                            "rule__InternalMetric__ShortNameAssignment_3");
                    put(grammarAccess.getInternalMetricAccess().getDescriptionAssignment_5(),
                            "rule__InternalMetric__DescriptionAssignment_5");
                    put(grammarAccess.getInternalMetricAccess().getParameterAssignment_8_2(),
                            "rule__InternalMetric__ParameterAssignment_8_2");
                    put(grammarAccess.getInternalMetricAccess().getDefinitionAssignment_9(),
                            "rule__InternalMetric__DefinitionAssignment_9");
                    put(grammarAccess.getParameterAccess().getNameAssignment_1(), "rule__Parameter__NameAssignment_1");
                    put(grammarAccess.getParameterAccess().getShortnameAssignment_3(),
                            "rule__Parameter__ShortnameAssignment_3");
                    put(grammarAccess.getParameterAccess().getDescriptionAssignment_5(),
                            "rule__Parameter__DescriptionAssignment_5");
                    put(grammarAccess.getParameterAccess().getDefaultValueAssignment_7(),
                    ...
                    put(grammarAccess.getWeightedMetricAccess().getWeightsAssignment_2(),
                            "rule__WeightedMetric__WeightsAssignment_2");
                    put(grammarAccess.getStepwiseMetricAccess().getInnerMetricAssignment_2(),
                    ...
                    put(grammarAccess.getRatioMetricAccess().getDenominatorMetricAssignment_4(),
                            "rule__RatioMetric__DenominatorMetricAssignment_4");
                    put(grammarAccess.getBoundAndWeightAccess().getUpperBoundAssignment_1(),
                            "rule__BoundAndWeight__UpperBoundAssignment_1");
                    put(grammarAccess.getBoundAndWeightAccess().getWeightAssignment_3(),
                            "rule__BoundAndWeight__WeightAssignment_3");
                    put(grammarAccess.getMetricAndWeightAccess().getMetricAssignment_1(),
                            "rule__MetricAndWeight__MetricAssignment_1");
                    put(grammarAccess.getMetricAndWeightAccess().getWeightAssignment_3(),
